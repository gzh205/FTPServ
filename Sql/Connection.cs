...
namespace FTPServ.Sql
{
    public class Connection
    {
        ...
        public Connection(string connectionString, Type type)
        {
            connection = Activator.CreateInstance(type, connectionString) as DbConnection;
        }
        /// <summary>
        /// 构造函数，不建议直接调用
        /// </summary>
        ...
        {
            DbConnection sqlConn = connection;
